...
<div class="constitution">
    <h1 class="noUnderscore">BWS: THE FINAL FANTASY BYLAWS</h1>
    ...
    <div class="subBlock">
        <p>If there is a trade that is in question, i.e. ⅔ of the league or more(not including the two people in the league, 6 out of the remaining 8 managers) thinks possible collusion is at play, The Commissioners will then be in contact with both parties of trade to determine the trade “value.” As a team, we will tend to be on the lighter side of collusion and may even include a third-party if needed.</p>
    ...
    <div class="subBlock">
        <p>Trade deadline is Week 13. Trading will resume after week 17.</p>
    </div>
    ...
    <div class="subBlock">
        <p>A total of 6 veto votes are required to veto a trade(not including the two people involved in the trade). Vetoes are only appropriate in instances of collusion or an egregious mismatch of value (i.e. CMC for a backup kicker). Not liking a trade does not warrant a veto.</p>
    </div>
    ...
    <p>League dues are set at {dues}$. Dues are collected through <a href="https://www.leaguesafe.com/league/4020968">LeagueSafe</a> and collection will be sent out no later than the first of August. Pay your fucking dues or Oli will hunt you down and spear you in the throat (Oli please pay your dues). In the event that a manager fails to pay before the deadline, a 10% penalty will be addd to their payment and will go towards the payouts at the end of the year.</p>
